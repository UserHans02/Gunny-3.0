...
namespace GameServerScript.AI.NPC
{
    public class HardCaptainAi : ABrain
    {
        ...
        private static string[] AllAttackChat = new string[] {
            "Đây là nụ hôn của cái chết!",

            "Bạn nhận được điên!",

            "Super bất khả chiến bại trận động đất <br/> ...... sốc ... sốc ......"
        };

        private static string[] ShootChat = new string[]{
            "Thả nó vào kính của bạn.",

            "Xem Kota so sánh với tiềm năng của bạn nhiều"
        };
        ...
        private static string[] JumpChat = new string[]{
             "Đối với chiến thắng của bạn, <br/> bắn vào tôi!",

             "Sau đó, bạn di chuyển nửa bước tôi đã giết!",

             "Cao! <br/> thực sự là cao!"
        };

        private static string[] KillAttackChat = new string[]{
             "Siêu máy bay ném bom! !"
        };
        #endregion
