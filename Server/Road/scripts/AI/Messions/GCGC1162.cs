...
{
    public class GCGC1162 : AMissionControl
    {
        ...
        {
            if (boss1 != null && boss1.IsLiving == false && boss2 != null && boss2.IsLiving == false && boss3 != null && boss3.IsLiving == false)
            {               
                return true;
            }
            return false;
