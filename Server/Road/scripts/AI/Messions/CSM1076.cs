...
namespace GameServerScript.AI.Messions
{
    public class CSM1076 : AMissionControl
    {
        ...
        public override void OnStartGame()
        {
            ...
            m_king.Say("Bạn hạ thấp người dân thường, dám tự tin vương quốc của tôi!", 0, 3000);
        ...
        public override bool CanGameOver()
        {
            ...
            if (m_state == secondBossID && m_secondKing == null)
            {
                ...
                m_secondKing.Say("<span class='red'>Bạn chọc tức tôi, tôi sẽ không tha thứ cho bạn!</span>", 0, 3000);
