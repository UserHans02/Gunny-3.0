...
{
    public class GCGC1161 : AMissionControl
    {
        ...
        private int redNpcID = 7001;

        private int blueNpcID = 7002;
                ...
                else
                {
                    if (redCount < 12)
                    {
                        if (12 - redCount >= 4)
                        {
                            for (int i = 0; i < 4; i++)
                            {
                                if (redTotalCount < 12 && redCount != 12)
                                {
                                    redTotalCount++;
                        ...
                        if (blueCount < 3 && blueTotalCount < 3)
                        {
                            blueTotalCount++;
                            blueNpc.Add(Game.CreateNpc(blueNpcID, 1467, 495, 1));
                        }
        ...
        public override bool CanGameOver()
        {
            ...
            if (result && redTotalCount == 12 && blueTotalCount == 3)
            {
                Game.IsWin = true;
                return true;
            }
