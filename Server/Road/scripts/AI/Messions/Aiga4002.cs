...
{
    public class Aiga4002 : AMissionControl
    {
...
SomeNpc.Add(Game.CreateNpc(7003, 900 * 100, 505, 1));
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                {
                    SomeNpc.Add(Game.CreateNpc(Gati, 1000 + (i + 1) * 100, 515, 1));
                }
            }
            ...
            if (Game.TurnIndex > 1 && Game.CurrentPlayer.Delay > Game.PveGameDelay)
            {
                for (int i = 0; i < 4; i++)
                {
                    if (redTotalCount < 15)
                    {
                        ...
                        {
                            SomeNpc.Add(Game.CreateNpc(Gati, 920 + (i + 1) * 100, 505, 1));
                        }
                        else
                        {
