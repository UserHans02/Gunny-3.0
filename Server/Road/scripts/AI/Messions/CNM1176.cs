...
namespace GameServerScript.AI.Messions
{
    public class CNM1176 : AMissionControl
    {
        ...
        private int m_state = 1176;

        private int turn = 0;

        private int firstBossID = 1176;

        private int secondBossID = 1177;
        ...
        public override void OnStartGame()
        {
            ...
            m_king = Game.CreateBoss(m_state, 900, 590, -1, 0);

            m_king.FallFrom(900, 690, "fall", 0, 2, 1000);
