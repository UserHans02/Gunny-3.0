...
<body>
    <form id="form1" runat="server" method="post" action="Default.aspx" >
        <table class="table-content" width="100%" cellpadding="0" cellspacing="." >
            <tr>
            ...
            <tr>
                ...
                <td align="left" valign="top" height="10">
                    ...
                    <asp:CompareValidator id="CompareValidator1" 
                        ...
                        ControlToCompare="TxtRePassword" Text="*">
            ...
            <tr>
                ...
                <td align="left" valign="top" height="10">
                    ...
                    <asp:RequiredFieldValidator 
                        ...
                        ForeColor="Red" Text="*"
                        ErrorMessage="Bạn chưa chon giới tính!"			 
            ...
            <tr>
                <td align="right" valign="top" height="10"> Mã xác nhận</td>
                <td align="left" valign="top" height="10">&nbsp;<img src="Handler.ashx" /></td>
            </tr>
            <tr>
                <td align="right" valign="top" height="10"> Nhập mã xác nhận</td>
                <td align="left" valign="top" height="10">
